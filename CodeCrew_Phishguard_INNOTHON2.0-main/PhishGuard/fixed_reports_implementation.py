"""
Fixed implementation of Reports Tab with proper visibility of form elements
"""
...
def createReportsTab(self, parent_widget):
    ...
    report_frame.setFixedHeight(480)  # Fixed height to ensure visibility
    ...
    # Form layout for report options with VISIBLE elements
    form_layout = QFormLayout()
    form_layout.setSpacing(15)
    form_layout.setContentsMargins(0, 0, 0, 0)
    form_layout.setLabelAlignment(Qt.AlignLeft | Qt.AlignVCenter)
    form_layout.setFieldGrowthPolicy(QFormLayout.AllNonFixedFieldsGrow)
    form_layout.setVerticalSpacing(20)  # Increased vertical spacing
    ...
    self.format_combo.setFixedHeight(35)  # Fixed height
    ...
    preview_button.setMinimumHeight(40)  # Increased height
    ...
    generate_button.setIcon(self.get_icon("report") if hasattr(self, 'get_icon') else QIcon())
    ...
    generate_button.setMinimumHeight(40)  # Increased height
