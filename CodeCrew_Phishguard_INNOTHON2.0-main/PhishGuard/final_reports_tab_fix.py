"""
Replacement implementation for the Reports tab in PhishGuard GUI
"""

def fixed_reports_tab_code():
    """
    Return the code for the createReportsTab method
    """
    return """
    def createReportsTab(self, parent_widget):
        ...
        self.report_type_combo.setFixedHeight(32)  # Reduced height
        ...
        self.time_period_combo.setFixedHeight(32)  # Reduced height
        ...
        self.dept_filter.setFixedHeight(32)  # Reduced height
        ...
        self.format_combo.setFixedHeight(32)  # Reduced height
        ...
        # Add buttons layout to report layout
        report_layout.addLayout(buttons_layout)
        
        # Add report frame to main layout
        ...
        for i in range(5):
            ...
            view_btn.setStyleSheet(
                "QPushButton { font-size: 11px; color: #0066cc; background-color: transparent; "
                "border: 1px solid #0066cc; border-radius: 3px; padding: 3px 8px; }"
            ...
            delete_btn.setStyleSheet(
                "QPushButton { font-size: 11px; color: #dc3545; background-color: transparent; "
                "border: 1px solid #dc3545; border-radius: 3px; padding: 3px 8px; }"
                "QPushButton:hover { background-color: #ffebeb; }"
            )
        ...
        # Add previous reports frame to main layout
